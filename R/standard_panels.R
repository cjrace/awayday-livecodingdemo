    ...
    gov_main_layout(
      gov_row(
        column(
          ...
          a(href = "mailto:schoolworkforce.statistics@education.gov.uk", "schoolworkforce.statistics@education.gov.uk", .noWS = c("after")), ".",
          br(),
          h2("Find more information on the data"),
          "The data used to produce the dashboard, along with methodological information can be found on ",
          a(href = "https://explore-education-statistics.service.gov.uk/find-statistics/school-workforce-in-england", "Explore Education Statistics", .noWS = c("after")),
          ".",
          br(),
          h2("Contact us"),
          "If you have questions about the dashboard or data within it, please contact us at ",
          a(href = "mailto:schoolworkforce.statistics@education.gov.uk", "schoolworkforce.statistics@education.gov.uk", .noWS = c("after")), br(),
          h2("See the source code"),
          "The source code for this dashboard is available in our ",
          a(href = "https://github.com/dfe-analytical-services/awayday-livecodingdemo", "GitHub repository", .noWS = c("after")),
          ".",
          br()
        ),
        column(
